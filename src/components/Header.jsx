      ...
      <div className="flex items-center gap-6">
        <div className="relative">
          <button
            ...
            className="relative text-slate-300 hover:text-slate-100 focus:outline-none cursor-pointer
            hover:bg-slate-700 p-2 rounded-full"
          >
            <Bell size={22} />
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 bg-slate-800 rounded-lg shadow-xl border border-slate-700 py-2 z-50">
              ...
              <div className="border-t border-slate-700 mt-2 pt-2 px-4">
                <button className="text-sm text-slate-300 hover:text-slate-100 w-full text-center">
